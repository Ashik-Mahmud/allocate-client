...
const Loader = ({ type, pageName, componentName, className }: Props) => {
    // Full Page Layout vs Inline Component Layout
    const isPage = type === "page";

    // Optional Loading Text
    const loadingText = isPage && pageName ? `Loading ${pageName || "page"}...` : componentName ? `${componentName || "component"}...` : 'Preparing your workspace';
