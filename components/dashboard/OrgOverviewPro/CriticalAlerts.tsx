    ...
    return (
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-6">
                <div className="p-3 rounded-xl bg-gradient-to-br from-rose-200 to-rose-100 dark:from-rose-800/50 dark:to-rose-900/30">
            ...
            <div className="space-y-2.5">
                {alerts.map((alert, idx) => (
                    <div
                        ...
                        className="group p-4 rounded-lg border border-rose-200 dark:border-rose-900/30 bg-gradient-to-r from-rose-50/50 to-rose-50/25 dark:from-rose-950/30 dark:to-rose-950/10 hover:border-rose-300 dark:hover:border-rose-800 hover:shadow-md transition-all cursor-pointer animate-in fade-in slide-in-from-top-2"
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between gap-2">
                            ...
                            <button
                                ...
                                className="flex-shrink-0 text-xs font-semibold px-3 py-1.5 rounded-lg bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-700 hover:to-rose-600 text-white transition-all group-hover:shadow-md active:scale-95 whitespace-nowrap"
                            >
                                Top Up
                            </button>
                        </div>
                            ...
                            <div className="mt-4 pt-4 border-t border-rose-200 dark:border-rose-900/30 animate-in fade-in duration-200">
                                <div className="space-y-2">
                                    <div className="flex items-start gap-2">
                                        <div className="w-1 h-1 rounded-full bg-rose-600 mt-2 flex-shrink-0" />
                                        <div>
