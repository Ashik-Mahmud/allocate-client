    ...
    return (
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-6">
                <div className="p-3 rounded-xl bg-linear-to-br from-yellow-200 to-yellow-100 dark:from-yellow-800/50 dark:to-yellow-900/30">
            ...
            <div className="mb-6 p-4 rounded-lg bg-linear-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 border border-yellow-200 dark:border-yellow-900/30">
                    ...
                    return (
                        <div
                            ...
                            className={`p-4 rounded-lg border transition-all ${
                                isMostUsed
                                    ? 'border-yellow-200 dark:border-yellow-900/30 bg-linear-to-r from-yellow-50/50 to-yellow-50/25 dark:from-yellow-950/30 dark:to-yellow-950/10'
