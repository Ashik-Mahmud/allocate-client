...
const StaffUserCard = ({ user }: UserProps) => {
    return (
        <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 transition-all hover:border-slate-300 hover:shadow-md dark:border-slate-800 dark:bg-zinc-950">

            {/* Top Section: Avatar & Role */}
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                    <div className="relative">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-100 font-bold text-slate-600 dark:bg-zinc-900 dark:text-zinc-400">
                            {user.photo ? (
                        ...
                        {user.is_verified && (
                            <div className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-white p-0.5 dark:bg-zinc-950">
            ...
            <div className="mt-6 space-y-3">
                ...
                <div className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50/50 p-3 dark:border-zinc-800 dark:bg-zinc-900/50">
            ...
            <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4 dark:border-zinc-800">
                ...
                <div className="flex items-center gap-2">
                    {user.last_login ? (
                        ...
                        <span className="text-[11px] font-medium text-slate-400">Never logged in</span>
                    )}
                </div>
            </div>
        </div>
