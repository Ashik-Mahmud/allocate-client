...
const featureVisuals = {
    ...
    organization: {
        src: "/assets/admin/organizations.png",
        alt: "Organization workspace dashboard view",
    },
    resources: {
        src: "/assets/org/resource-management.png",
    ...
    bookings: {
        src: "/assets/org/booking_management.png",
        alt: "Booking operations dashboard view",
    },
    billing: {
        src: "/assets/org/billing_management.png",
    ...
    dashboard: {
        src: "/assets/org/pro_org_dashboard.png",
        alt: "Analytics dashboard view",
    },
    community: {
        src: "/assets/org/community_hub.png",
    ...
    calendar: {
        src: "/assets/staff/availability_calendar.png",
        alt: "Booking availability calendar dashboard view",
    },
} as const;
